...
//        tecniques.setName("Home");
//        final String result = tecniques.getName();
...
//        String name = "Home";
//        tecniques.setName(name);
//        assertEquals("Home", tecniques.getName(), "Fields don't match");
//    }
//
//    @DisplayName("Test Techniques With Invalid Name")
//    @Test
...
//        tecniques.setPrice(5.0);
//        final double result = tecniques.getPrice();
...
//        double price = 5.0;
//        tecniques.setPrice(price);
//        assertEquals(5.0, tecniques.getPrice(), "Fields don't match");
//    }
//
//    @DisplayName("Test Techniques With Invalid Price")
//    @Test
...
//        tecniques.setAmount(5);
//        final double result = tecniques.getAmount();
...
//        int amount = 5;
//        tecniques.setAmount(amount);
//        assertEquals(5, tecniques.getAmount(), "Fields don't match");
//    }
//
//    @DisplayName("Test Techniques With Invalid Amount")
//    @Test
